...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'basilisk' => [
            'driver' => 'mysql',
            'host' => env('DB_BASILISK_HOST', '127.0.0.1'),
            'port' => env('DB_BASILISK_PORT', '13306'),
            'database' => env('DB_BASILISK_DATABASE', 'basilisk'),
            'username' => env('DB_BASILISK_USERNAME', ''),
            'password' => env('DB_BASILISK_PASSWORD', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
